...
public class Auto2023Dreapta_test extends LinearOpMode {
    ...
    public static double preloadX = 47;
    public static double preloadY = 3.2;
    public static double preloadRot = 45;
    public static double preloadTg = 45;
    ...
    public static double precycleX = 49;
    public static double precycleY = -7;
    public static double precycleRot = 90;

    public static double cycle_x_init=50.7;
    ...
    private  void main(){
        ...
        setTargetPositionServoAfter("clawRotate",0.358,600); //0.362
        ...
        lift.setTargetPosition(1190);
        clawRotate.setPosition(0.355); //0.362
        drive.setWeightedDrivePower(new Pose2d(1,0,0));
        drive.update();
        Wait(250);
        drive.setWeightedDrivePower(new Pose2d(0,0,0));
       ...
       // Pose2d cPos = drive.getPoseEstimate();
        ...
        for(int i=0;i<1 && opModeIsActive() && !isStopRequested();i++){
            if(i<4)
            brat.setPower(1);
            else
                brat.setPower(1);
            ...
            if(i < 2) {
                traj = drive.trajectoryBuilder(drive.getPoseEstimate(), Math.toRadians(-120))
                        .splineToSplineHeading(new Pose2d(precycleX + i * 0.5, precycleY, Math.toRadians(precycleRot)), Math.toRadians(-90))
                        //.lineToLinearHeading(new Pose2d(34+3,-63+50,Math.toRadians(180)))
                        .splineTo(new Vector2d(cycle_x + i * 0.5, cycle_y-0.1*i), Math.toRadians(-90))
                        //.lineToLinearHeading(new Pose2d(precycleX,precycleY,Math.toRadians(precycleRot)))
                        //.splineToLinearHeading()
                        .build();
            } else if(i==2){
                traj = drive.trajectoryBuilder(drive.getPoseEstimate(), Math.toRadians(-120))
                        .splineToSplineHeading(new Pose2d(precycleX + i * 0.5, precycleY + 1, Math.toRadians(precycleRot)), Math.toRadians(-90))
                        //.lineToLinearHeading(new Pose2d(34+3,-63+50,Math.toRadians(180)))
                ...
                traj = drive.trajectoryBuilder(drive.getPoseEstimate(), Math.toRadians(-120))
                        .splineToSplineHeading(new Pose2d(precycleX + i * 0.5, precycleY, Math.toRadians(precycleRot)), Math.toRadians(-90))
                        //.lineToLinearHeading(new Pose2d(34+3,-63+50,Math.toRadians(180)))
                        .splineTo(new Vector2d(cycle_x + i * 0.1, cycle_y + 1.2 * (i-2)), Math.toRadians(-90))
                        //.lineToLinearHeading(new Pose2d(precycleX,precycleY,Math.toRadians(precycleRot)))
                        //.splineToLinearHeading()
                        .build();
            }
            ...
            traj = drive.trajectoryBuilder(targetCyclePos,false)
                    .lineTo(new Vector2d(precycleX + i * 0.7 ,precycleY))
                    .splineToSplineHeading(new Pose2d(preloadX + i * 0.7,preloadY,Math.toRadians(preloadRot)),Math.toRadians(preloadTg))
                    .build();

            /*
            traj = drive.trajectoryBuilder(targetCyclePos,false)
                    .lineToLinearHeading(new Pose2d(preloadX + i * 0.6,preloadY,Math.toRadians(preloadRot)))
                    .build();
            ...
            Wait(100);
            brat.setPower(1);
            setTargetPositionAfter("brat",bratUp,350);
            setTargetPositionServoAfter("clawRotate",0.358,400); //0.367
