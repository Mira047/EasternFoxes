...
@Autonomous(name="Teste Stanga", group="Linear Opmode")
@Config
public class TestStanga extends LinearOpMode {
    ...
    public void main(){
        ...
        Trajectory second = drive.trajectoryBuilder(drive.getPoseEstimate(),Math.toRadians(UNGHI_TG_1))
                ...
                .splineTo(new Vector2d(cycle_x,cycle_y),Math.toRadians(UNGHI_TG_3))
                //.lineToLinearHeading(new Pose2d(precycleX,precycleY,Math.toRadians(precycleRot)))
                //.splineToLinearHeading()
                .build();
        telemetry.addLine("hai cu 2");
        telemetry.update();
