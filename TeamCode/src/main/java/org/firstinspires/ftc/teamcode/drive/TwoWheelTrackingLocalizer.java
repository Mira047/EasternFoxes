...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = -1.2; // X is the up and down direction
    public static double PARALLEL_Y = -14/2; // Y is the strafe direction

    public static double PERPENDICULAR_X = -4;
    public static double PERPENDICULAR_Y = 0.27;
    ...
    public TwoWheelTrackingLocalizer(HardwareMap hardwareMap,SampleMecanumDrive d) {
        super(Arrays.asList(
        ...
        parallelEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "frontright")); // dreapta
