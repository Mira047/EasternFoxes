...
@Autonomous(name="Auto Dreapta Corectie Boss", group="Linear Opmode")
@Config
public class AutoDreaptaCorectieBoss extends LinearOpMode {
    ...
    public static double corectieVitezaRot = 0.35;
    ...
    CorectieOutput corectie(){
        ...
        while (true && opModeIsActive() && !isStopRequested()){
            ...
            corectieData.rotImu = drive.getRawExternalHeading();
        ...
        telemetry.addData("Rotire de acum",drive.getRawExternalHeading());
        telemetry.update();
        double cdist = 0;
        cdist = (dist + dist2) / 2;
