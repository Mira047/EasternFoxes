...
@TeleOp(name="Teleop2022_v2", group="Linear Opmode")
@Config
//s0Ft ArabEsc
public class Teleop2022_v2 extends LinearOpMode {
    ...
    public static int extenderUp = -1450;
    public static int extenderIntake = 0;

    public static double turretRot = 115;
    public static double turret0 = 0;
    ...
    int x_use = 0;
    int up_use = 0;
    public static int antiRetardUp = 400;
    public static int fromAuto = 0;
    turret_rotation tr;
    GamepadUpdater gamepadUpdater;
    static Pose2d startPose = new Pose2d();
    ...
    public void runOpMode(){
        ...
        //duckServo = hardwareMap.get(Servo.class,"duck_servo");
