...
@TeleOp(name="TeleopOdometrie", group="Linear Opmode")
@Config
//s0Ft ArabEsc
public class TeleopOdometrie extends LinearOpMode {
    ...
    public  static  double clawRotateInit = 0.513;//0.92;
    ...
    public void runOpMode(){
        ...
        while (opModeIsActive() && !isStopRequested()){
            ...
            if(!drive.isBusy() && driveIsBusy == false) {
